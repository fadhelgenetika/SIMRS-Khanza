...
public final class RMDataAsuhanGizi extends javax.swing.JDialog {
    ...
    public RMDataAsuhanGizi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Monitoring & Evaluasi","NIP","Nama Petugas","Diagnosa Medis"
        }){
...
//        RiwayatPersonal.setDocument(new batasInput((int)300).getKata(RiwayatPersonal));
            ...
            Map<String, Object> param = new HashMap<>(); 
                ...
                if(TCari.getText().equals("")){
                    Valid.MyReportqry("rptDataAsuhanGiziPasien.jasper","report","::[ Data Asuhan Gizi Pasien ]::",
                        ...
                        "asuhan_gizi.diagnosis,asuhan_gizi.intervensi_gizi,asuhan_gizi.monitoring_evaluasi,asuhan_gizi.nip,petugas.nama, (SELECT kamar_inap.diagnosa_awal from kamar_inap WHERE kamar_inap.no_rawat=asuhan_gizi.no_rawat limit 1) as diagnosa_awal "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("intervensi_gizi"),rs.getString("monitoring_evaluasi"),rs.getString("nip"),rs.getString("nama"),Sequel.cariIsi("select kamar_inap.diagnosa_awal from kamar_inap where kamar_inap.diagnosa_awal<>'' and kamar_inap.no_rawat='"+rs.getString("no_rawat")+"'")
                    });
                }
            } catch (Exception e) {
