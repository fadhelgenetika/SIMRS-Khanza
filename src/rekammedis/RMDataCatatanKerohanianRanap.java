 ...
 * @author perpustakaan
 */
public final class RMDataCatatanKerohanianRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMDataCatatanKerohanianRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Catatan Kerohanian Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("catatan_kerohanian_ranap","?,?,?,?,?","Data",5,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataCatatanKerohanianRanap.jasper","report","::[ Data Catatan Kerohanian Rawat Inap ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,catatan_kerohanian_ranap.tanggal,catatan_kerohanian_ranap.jam,catatan_kerohanian_ranap.uraian,"+
                    "catatan_kerohanian_ranap.nip,petugas.nama from catatan_kerohanian_ranap inner join reg_periksa on catatan_kerohanian_ranap.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_keperawatan_ranap.nip=petugas.nip where "+
                    "catatan_kerohanian_ranap.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' order by catatan_kerohanian_ranap.tanggal",param);
            }else{
                Valid.MyReportqry("rptDataCatatanKerohanianRanap.jasper","report","::[ Data Catatan Kerohanian Rawat Inap ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,catatan_kerohanian_ranap.tanggal,catatan_kerohanian_ranap.jam,catatan_kerohanian_ranap.uraian,"+
                    "catatan_kerohanian_ranap.nip,petugas.nama from catatan_kerohanian_ranap inner join reg_periksa on catatan_kerohanian_ranap.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_kerohanian_ranap.nip=petugas.nip where "+
                    "catatan_kerohanian_ranap.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and "+
                    "(reg_periksa.no_rawat like '%"+TCari.getText().trim()+"%' or pasien.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                    "pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or catatan_kerohanian_ranap.nip like '%"+TCari.getText().trim()+"%' or petugas.nama like '%"+TCari.getText().trim()+"%') "+
                    "order by catatan_kerohanian_ranap.tanggal ",param);
            }  
        }
    ...
    private void MnCatatanKeperawatanRawatInapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCatatanKeperawatanRawatInapActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("dpjp",dpjp);   
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptFormulirCatatanKerohanianRanap.jasper","report","::[ Formulir Catatan Kerohanian Rawat Inap ]::",
                    ...
                    "pasien.jk,pasien.tgl_lahir,catatan_kerohanian_ranap.tanggal,catatan_kerohanian_ranap.jam,catatan_kerohanian_ranap.uraian,"+
                    "petugas.nama from catatan_kerohanian_ranap inner join reg_periksa on catatan_kerohanian_ranap.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_kerohanian_ranap.nip=petugas.nip where reg_periksa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataCatatanKerohanianRanap dialog = new RMDataCatatanKerohanianRanap(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_kerohanian_ranap.nip=petugas.nip where "+
                    "catatan_kerohanian_ranap.tanggal between ? and ? order by catatan_kerohanian_ranap.tanggal DESC ,catatan_kerohanian_ranap.jam DESC");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,catatan_kerohanian_ranap.tanggal,catatan_kerohanian_ranap.jam,catatan_kerohanian_ranap.uraian,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_kerohanian_ranap.nip=petugas.nip where "+
                    "catatan_kerohanian_ranap.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or catatan_kerohanian_ranap.nip like ? or petugas.nama like ?) "+
                    "order by catatan_kerohanian_ranap.tanggal DESC, catatan_kerohanian_ranap.jam DESC");
            }
    ...
    private void ganti() {
        if(Sequel.mengedittf("catatan_kerohanian_ranap","tanggal=? and jam=? and no_rawat=?","no_rawat=?,tanggal=?,jam=?,uraian=?,nip=?",8,new String[]{
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from catatan_kerohanian_ranap where tanggal=? and jam=? and no_rawat=?",3,new String[]{
