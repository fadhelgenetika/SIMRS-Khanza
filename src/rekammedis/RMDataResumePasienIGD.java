 ...
 * @author perpustakaan
 */
public final class RMDataResumePasienIGD extends javax.swing.JDialog {
    ...
    private String tanggalKeluar="",jamKeluar="";
    
    private String txtKeluhan="",txtJalannyaPenyakit="",txtPemeriksaanPenunjang="",txtHasilLaborat="",txtObat2an="",txtEKG="";
    private String keadaan="",kesadaran="",gcs="",tb="",bb="",td="",nadi="",rr="",suhu="",spo="",kepala="",mata="",gigi="",leher="",thoraks="",abdomen="",genital="",ekstremitas="",ket_fisik="",ket_lokalis="";
    
    /** Creates new form DlgRujuk
     * @param parent
     * @param modal */
    public RMDataResumePasienIGD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        ProsedurSekunder3.setDocument(new batasInput((int)80).getKata(ProsedurSekunder3));
    ...
    private void initComponents() {
        ...
        MnLaporanResumeIGD = new javax.swing.JMenuItem();
        ...
        MnLaporanResumeIGD.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResumeIGD.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResumeIGD.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResumeIGD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResumeIGD.setText("Laporan Resume Pasien dan SEP");
        MnLaporanResumeIGD.setName("MnLaporanResumeIGD"); // NOI18N
        MnLaporanResumeIGD.setPreferredSize(new java.awt.Dimension(250, 26));
        MnLaporanResumeIGD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResumeIGDActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResumeIGD);
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Resume Medis Pasien IGD ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        BtnDokter1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/data-transfer.png"))); // NOI18N
        BtnDokter1.setMnemonic('2');
        BtnDokter1.setText("Tampil Data");
        BtnDokter1.setToolTipText("Alt+2");
        BtnDokter1.setMaximumSize(new java.awt.Dimension(77, 30));
        BtnDokter1.setMinimumSize(new java.awt.Dimension(77, 30));
        ...
        BtnDokter1.setBounds(120, 90, 120, 30);
        ...
        cmbTanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-09-2024" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("resume_pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",26,new String[]{
                ...
                System.err.println(cmbTanggal.getDate().toString());
                
                    Sequel.menyimpantf("igd_resume_datetime","?,?,?,?","No.Rawat",4,new String[]{
                        TNoRw.getText(),Valid.SetTgl(cmbTanggal.getSelectedItem()+""),CmbJam.getSelectedItem().toString()+":"+CmbMenit.getSelectedItem().toString()+":"+CmbDetik.getSelectedItem().toString(),KodeDokter.getText()
                    });
                    tampil();
                    emptTeks();
            }
    ...
    private void MnLaporanResumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResumeActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("kdDok",tbObat.getValueAt(tbObat.getSelectedRow(),4).toString());
//            System.err.println(tbObat.getValueAt(tbObat.getSelectedRow(),4));
            tanggal="";
...
//            System.out.println("Kode Dokter : "+KodeDokter.getText());
            
            txtKeluhan = Sequel.cariIsi("SELECT penilaian_medis_igd.keluhan_utama FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            txtKeluhan = txtKeluhan + "; " + Sequel.cariIsi("SELECT penilaian_medis_igd.rps FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            txtKeluhan = txtKeluhan + "; " + Sequel.cariIsi("SELECT penilaian_medis_igd.rpk FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            txtKeluhan = txtKeluhan + "; " + Sequel.cariIsi("SELECT penilaian_medis_igd.rpd FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            txtKeluhan = txtKeluhan + "; " + Sequel.cariIsi("SELECT penilaian_medis_igd.rpo FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            txtKeluhan = txtKeluhan + "; " + Sequel.cariIsi("SELECT penilaian_medis_igd.alergi FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            
            Keluhan.setText(txtKeluhan);
            
            txtJalannyaPenyakit = "";
                    
            keadaan = Sequel.cariIsi("SELECT penilaian_medis_igd.keadaan FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            kesadaran = Sequel.cariIsi("SELECT penilaian_medis_igd.kesadaran FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            gcs = Sequel.cariIsi("SELECT penilaian_medis_igd.gcs FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            tb = Sequel.cariIsi("SELECT penilaian_medis_igd.tb FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            bb = Sequel.cariIsi("SELECT penilaian_medis_igd.bb FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            td = Sequel.cariIsi("SELECT penilaian_medis_igd.td FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            nadi = Sequel.cariIsi("SELECT penilaian_medis_igd.nadi FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            rr = Sequel.cariIsi("SELECT penilaian_medis_igd.rr FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            suhu = Sequel.cariIsi("SELECT penilaian_medis_igd.suhu FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            spo = Sequel.cariIsi("SELECT penilaian_medis_igd.spo FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            kepala = Sequel.cariIsi("SELECT penilaian_medis_igd.kepala FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            mata = Sequel.cariIsi("SELECT penilaian_medis_igd.mata FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            gigi = Sequel.cariIsi("SELECT penilaian_medis_igd.gigi FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            leher = Sequel.cariIsi("SELECT penilaian_medis_igd.leher FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            thoraks = Sequel.cariIsi("SELECT penilaian_medis_igd.thoraks FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            abdomen = Sequel.cariIsi("SELECT penilaian_medis_igd.abdomen FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            genital = Sequel.cariIsi("SELECT penilaian_medis_igd.genital FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            ekstremitas = Sequel.cariIsi("SELECT penilaian_medis_igd.ekstremitas FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            ket_fisik = Sequel.cariIsi("SELECT penilaian_medis_igd.ket_fisik FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            ket_lokalis = Sequel.cariIsi("SELECT penilaian_medis_igd.ket_lokalis FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            
            if(!keadaan.isEmpty()){
                txtJalannyaPenyakit=txtJalannyaPenyakit+"Keadaan Umum : "+keadaan;
            }
            
            if(!kesadaran.isEmpty()){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Kesadaran : "+kesadaran;
            }
            
            if(!gcs.isEmpty()){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", GCS : "+gcs;
            }
            
            if(!tb.isEmpty()){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Tinggi Badan (cm) : "+tb;
            }
            
            if(!bb.isEmpty()){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Berat Badan (Kg) : "+bb;
            }
            
            if(!td.isEmpty()){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Tekanan Darah (mmHg) : "+td;
            }
            
            if(!nadi.isEmpty()){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Nadi (x/menit) : "+nadi;
            }
            
            if(!rr.isEmpty()){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Respirasi (x/menit) : "+rr;
            }
            
            if(!suhu.isEmpty()){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Suhu (C) : "+suhu;
            }
            
            if(!spo.isEmpty()){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", SpO2 (%) : "+spo;
            }
            
            if(!kepala.equals("Normal")){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Kepala : "+kepala;
            }
            
            if(!mata.equals("Normal")){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Mata : "+mata;
            }
            
            if(!gigi.equals("Normal")){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Gigi & Mulut : "+gigi;
            }
            
            if(!leher.equals("Normal")){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Leher : "+leher;
            }
            
            if(!thoraks.equals("Normal")){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Thoraks : "+thoraks;
            }
            
            if(!abdomen.equals("Normal")){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Abdomen : "+abdomen;
            }
            
            if(!genital.equals("Normal")){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Genital & Anus : "+genital;
            }
            
            if(!ekstremitas.equals("Normal")){
                txtJalannyaPenyakit=txtJalannyaPenyakit+", Ekstremitas : "+ekstremitas;
            }
            
            if(!ket_fisik.isEmpty()){
                txtJalannyaPenyakit=txtJalannyaPenyakit+"; Ket. Fisik : "+ket_fisik;
            }
            
            if(!ket_lokalis.isEmpty()){
                txtJalannyaPenyakit=txtJalannyaPenyakit+"\n"+ket_lokalis;
            }
            
            txtObat2an = Sequel.cariIsi("SELECT penilaian_medis_igd.tata FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            
            JalannyaPenyakit.setText(txtJalannyaPenyakit+"\n"+txtObat2an);
            
//            txtPemeriksaanPenunjang = Sequel.cariIsi("SELECT penilaian_medis_igd.rad FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
//            PemeriksaanPenunjang.setText(txtPemeriksaanPenunjang);

            txtEKG = Sequel.cariIsi("SELECT penilaian_medis_igd.rad FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            
            txtPemeriksaanPenunjang = Sequel.cariIsi("SELECT hasil_radiologi.hasil from hasil_radiologi where hasil_radiologi.no_rawat='"+TNoRw.getText()+"'");
            
            if (!txtPemeriksaanPenunjang.isEmpty()){
                
                if(txtPemeriksaanPenunjang.contains("Kesan :")){
                    String[] txtPemeriksaanPenunjangCut = txtPemeriksaanPenunjang.split("Kesan :");
                    PemeriksaanPenunjang.setText(txtEKG+",\nKesan :"+txtPemeriksaanPenunjangCut[1]);
                } else if (txtPemeriksaanPenunjang.contains("Kesan:")){
                    String[] txtPemeriksaanPenunjangCut = txtPemeriksaanPenunjang.split("Kesan:");
                    PemeriksaanPenunjang.setText(txtEKG+",\nKesan :"+txtPemeriksaanPenunjangCut[1]);
                }
            ...
            txtHasilLaborat = Sequel.cariIsi("SELECT penilaian_medis_igd.lab FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
            HasilLaborat.setText(txtHasilLaborat);

//            txtObat2an = Sequel.cariIsi("SELECT penilaian_medis_igd.tata FROM penilaian_medis_igd,reg_periksa WHERE penilaian_medis_igd.no_rawat=reg_periksa.no_rawat and penilaian_medis_igd.no_rawat='"+TNoRw.getText()+"' AND penilaian_medis_igd.kd_dokter='"+KodeDokter.getText()+"'");
//            Obat2an.setText(txtObat2an);
        }
    ...
    private void MnLaporanResumeIGDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResumeIGDActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("prb",Sequel.cariIsi("select bpjs_prb.prb from bpjs_prb inner join bridging_sep on bpjs_prb.no_sep=bridging_sep.no_sep where bridging_sep.no_rawat==?",tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()));
            param.put("logo",Sequel.cariGambar("select gambar.bpjs from gambar"));
            
            param.put("dokter",tbObat.getValueAt(tbObat.getSelectedRow(),5).toString()); //?
            
//            System.err.println(tbObat.getValueAt(tbObat.getSelectedRow(),4));
            if(Sequel.cariIsi("select reg_periksa.status_lanjut from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText()).equals("Ralan")){
                param.put("ruang",Sequel.cariIsi("select poliklinik.nm_poli from poliklinik inner join reg_periksa on reg_periksa.kd_poli=poliklinik.kd_poli where reg_periksa.no_rawat=?",tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()));
                tanggalKeluar=Sequel.cariIsi("select DATE_FORMAT(tanggal_keluar, '%d-%m-%Y') as tanggal_keluar from igd_resume_datetime where no_rawat=?",tbObat.getValueAt(tbObat.getSelectedRow(),1).toString());
                jamKeluar=Sequel.cariIsi("select jam_keluar from igd_resume_datetime where no_rawat=?",tbObat.getValueAt(tbObat.getSelectedRow(),1).toString());
...
//                param.put("tanggalKeluar",tanggal);
            ...
            Valid.MyReport("rptResumeSEP.jasper","report","::[ SEP dan Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResumeIGDActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataResumePasienIGD dialog = new RMDataResumePasienIGD(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JMenuItem MnLaporanResumeIGD;
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            String tanggalUbah=Sequel.cariIsi("select tanggal_keluar from igd_resume_datetime where no_rawat='"+TNoRw.getText()+"'");
            String jamUbah=Sequel.cariIsi("select jam_keluar from igd_resume_datetime where no_rawat='"+TNoRw.getText()+"'");
            
            Valid.SetTgl(cmbTanggal,tanggalUbah);
            
            if (!jamUbah.isEmpty()){
                String[] jamUbahSplit = jamUbah.split(":");
                CmbJam.setSelectedItem(jamUbahSplit[0]);
                CmbMenit.setSelectedItem(jamUbahSplit[1]);
                CmbDetik.setSelectedItem(jamUbahSplit[2]);
            }
            
            //End Tanggal dan Jam Keluar
        }
    }
    ...
    private void ganti() {
        if(Sequel.mengedittf("resume_pasien","no_rawat=? and kd_dokter=?","no_rawat=?,kd_dokter=?,keluhan_utama=?,jalannya_penyakit=?,pemeriksaan_penunjang=?,hasil_laborat=?,diagnosa_utama=?,kd_diagnosa_utama=?,diagnosa_sekunder=?,kd_diagnosa_sekunder=?,diagnosa_sekunder2=?,kd_diagnosa_sekunder2=?,diagnosa_sekunder3=?,kd_diagnosa_sekunder3=?,diagnosa_sekunder4=?,kd_diagnosa_sekunder4=?,prosedur_utama=?,kd_prosedur_utama=?,prosedur_sekunder=?,kd_prosedur_sekunder=?,prosedur_sekunder2=?,kd_prosedur_sekunder2=?,prosedur_sekunder3=?,kd_prosedur_sekunder3=?,kondisi_pulang=?,obat_pulang=?",28,new String[]{
                ...
                Sequel.mengedittf("igd_resume_datetime","no_rawat=? and kd_dokter=?","no_rawat=?,tanggal_keluar=?,jam_keluar=?,kd_dokter=?",6,new String[]{
                    TNoRw.getText(),Valid.SetTgl(cmbTanggal.getSelectedItem()+""),CmbJam.getSelectedItem().toString()+":"+CmbMenit.getSelectedItem().toString()+":"+CmbDetik.getSelectedItem().toString(),KodeDokter.getText(),
                    tbObat.getValueAt(tbObat.getSelectedRow(),1).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),4).toString()
                });
               tampil();
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from resume_pasien where no_rawat=? and kd_dokter=?",2,new String[]{
            ...
            Sequel.queryu2tf("delete from igd_resume_datetime where no_rawat=? and kd_dokter=?",2,new String[]{
                tbObat.getValueAt(tbObat.getSelectedRow(),1).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),4).toString()
            });
