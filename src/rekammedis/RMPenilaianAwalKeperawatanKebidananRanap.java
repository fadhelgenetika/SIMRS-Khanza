...
//        RBedah.setDocument(new batasInput((int)100).getKata(RBedah));
        ...
        KeteranganKomplikasiKehamilan.setDocument(new batasInput((int)200).getKata(KeteranganKomplikasiKehamilan));
        ...
        KeteranganKomplikasiKB.setDocument(new batasInput((int)200).getKata(KeteranganKomplikasiKB));
        BerhentiKB.setDocument(new batasInput((int)20).getKata(BerhentiKB));
        AlasanBerhentiKB.setDocument(new batasInput((int)200).getKata(AlasanBerhentiKB));
        KebiasaanObatDiminum.setDocument(new batasInput((int)200).getKata(KebiasaanObatDiminum));
        ...
        Letak.setDocument(new batasInput((int)200).getKata(Letak));
        Presentasi.setDocument(new batasInput((int)10).getKata(Presentasi));
        Penurunan.setDocument(new batasInput((int)200).getKata(Penurunan));
        ...
        KeteranganInspekulo.setDocument(new batasInput((int)200).getKata(KeteranganInspekulo));
        KeteranganLakmus.setDocument(new batasInput((int)200).getKata(KeteranganLakmus));
        KeteranganCTG.setDocument(new batasInput((int)200).getKata(KeteranganCTG));
        KeteranganBerjalan.setDocument(new batasInput((int)200).getKata(KeteranganBerjalan));
        KeteranganEkstrimitasAtas.setDocument(new batasInput((int)200).getKata(KeteranganEkstrimitasAtas));
        KeteranganEkstrimitasBawah.setDocument(new batasInput((int)200).getKata(KeteranganEkstrimitasBawah));
        KeteranganKemampuanMenggenggam.setDocument(new batasInput((int)200).getKata(KeteranganKemampuanMenggenggam));
        KeteranganKemampuanKoordinasi.setDocument(new batasInput((int)200).getKata(KeteranganKemampuanKoordinasi));
        KeteranganAdakahPerilaku.setDocument(new batasInput((int)200).getKata(KeteranganAdakahPerilaku));
        KeteranganTinggalDengan.setDocument(new batasInput((int)200).getKata(KeteranganTinggalDengan));
        KeteranganNilaiKepercayaan.setDocument(new batasInput((int)200).getKata(KeteranganNilaiKepercayaan));
        KeteranganEdukasiPsikologis.setDocument(new batasInput((int)200).getKata(KeteranganEdukasiPsikologis));
        ...
        KeteranganDiagnosaKhususGizi.setDocument(new batasInput((int)200).getKata(KeteranganDiagnosaKhususGizi));
...
//        Tindakan.setDocument(new batasInput((int)1000).getKata(Tindakan));
    ...
    private void initComponents() {
        ...
        TanggalPersalinan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-07-2024" }));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-07-2024 10:53:17" }));
        ...
        HPHT.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-07-2024" }));
        ...
        TP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-07-2024" }));
        ...
        RiwayatKB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Belum Pernah", "Suntik", "Pil", "AKDR", "MOW", "KB Implant" }));
        ...
        PemeriksaanGenitalia.setBounds(346, 1090, 89, 23);
