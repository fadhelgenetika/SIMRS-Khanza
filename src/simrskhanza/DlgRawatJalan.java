...
import rekammedis.RMDataResumePasienIGD;
...
//        Catatan.setDocument(new batasInput((int)700).getKata(Catatan));
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgRawatJalan")){
                    if(petugas.getTable().getSelectedRow()!= -1){   
                        if(TabRawat.getSelectedComponent().getName().equals("Penanganan Petugas")){
        ...
        internalFrame2.setName("Penanganan Dokter");
        internalFrame3.setName("Penanganan Petugas");
        internalFrame4.setName("Penanganan Dokter & Petugas");
        internalFrame5.setName("Pemeriksaan");
        internalFrame6.setName("Pemeriksaan Obstetri");
        internalFrame7.setName("Pemeriksaan Ginekologi");
        panelDiagnosa1.setName("Diagnosa");
    ...
    private void initComponents() {
        ...
        BtnResumeIGD = new widget.Button();
        ...
        cmbKesadaran.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Compos Mentis", "Apatis", "Somnolence", "Sopor/Stupor", "Coma" }));
        ...
        TAlergi.setBounds(700, 10, 200, 20);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-10-2024" }));
        ...
        BtnResumeIGD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnResumeIGD.setText("Resume Pasien IGD");
        BtnResumeIGD.setFocusPainted(false);
        BtnResumeIGD.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnResumeIGD.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnResumeIGD.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnResumeIGD.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnResumeIGD.setName("BtnResumeIGD"); // NOI18N
        BtnResumeIGD.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnResumeIGD.setRoundRect(false);
        BtnResumeIGD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnResumeIGDActionPerformed(evt);
            }
        });
        FormMenu.add(BtnResumeIGD);
    ...
    private void TNoRwKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TNoRwKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            ...
            }else if(TabRawat.getSelectedComponent().getName().equals("Penanganan Petugas")){
                Valid.pindah(evt,DTPTgl,kdptg);
            }else if(TabRawat.getSelectedComponent().getName().equals("Penanganan Dokter & Petugas")){
                Valid.pindah(evt,DTPTgl,KdDok2);
            }else if(TabRawat.getSelectedComponent().getName().equals("Pemeriksaan")){
                Valid.pindah(evt,DTPTgl,KdPeg);
            }else if(TabRawat.getSelectedComponent().getName().equals("Pemeriksaan Obstetri")){
                Valid.pindah(evt,DTPTgl,TTinggi_uteri);
            }else if(TabRawat.getSelectedComponent().getName().equals("Pemeriksaan Ginekologi")){
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            System.out.println(TabRawat.getSelectedComponent().getName());
            //Mulai Simpan Tab
//            switch (TabRawat.getSelectedIndex()) {
            switch (TabRawat.getSelectedComponent().getName()) {
                //Tab Penanganan Dokter
                case "Penanganan Dokter" :
                    ...
                    break;
                //Tab Penanganan Petugas   
                case "Penanganan Petugas" :
                    ...
                    break;
                //Tab Penanganan Dokter & Petugas
                case "Penanganan Dokter & Petugas" :
                ...
                case "Pemeriksaan" :
                    if((!TKeluhan.getText().trim().equals(""))||(!TPemeriksaan.getText().trim().equals(""))||(!TSuhu.getText().trim().equals(""))||
                            (!TTensi.getText().trim().equals(""))||(!TAlergi.getSelectedItem().equals(""))||(!TTinggi.getText().trim().equals(""))||
                        ...
                        if(KdPeg.getText().trim().equals("")||TPegawai.getText().trim().equals("")){
                            ...
                            if(akses.getkode().equals("Admin Utama")){
                                if(Sequel.menyimpantf("pemeriksaan_ralan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",21,new String[]{
                                    ...
                                    SpO2.getText(),TGCS.getText(),cmbKesadaran.getSelectedItem().toString(),TKeluhan.getText(),TPemeriksaan.getText(),TAlergi.getSelectedItem().toString(),
                                    LingkarPerut.getText(),TindakLanjut.getText(),TPenilaian.getText(),TInstruksi.getText(),TEvaluasi.getText(),KdPeg.getText()})==true){
                                        tabModePemeriksaan.addRow(new Object[]{
                                            ...
                                            TKeluhan.getText(),TPemeriksaan.getText(),TAlergi.getSelectedItem().toString(),LingkarPerut.getText(),TindakLanjut.getText(),TPenilaian.getText(),TInstruksi.getText(),TEvaluasi.getText(),
                                        ...
                                        TPemeriksaan.setText("");TAlergi.setSelectedIndex(0);LingkarPerut.setText("");
                    ...
                    break;
                //Tab Pemeriksaan Obstetri
                case "Pemeriksaan Obstetri":
                    ...
                    break;
                //Tab Pemeriksaan Ginekologi
                case "Pemeriksaan Ginekologi":
                        ...
                        if(tbPemeriksaan.getSelectedRow()>-1){
                            if(akses.getkode().equals("Admin Utama")){
                                if(Sequel.mengedittf("pemeriksaan_ralan","no_rawat='"+tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1)+
                                    ...
                                    "alergi='"+TAlergi.getSelectedItem().toString()+"',lingkar_perut='"+LingkarPerut.getText()+"',"+
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnResumeIGDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnResumeIGDActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMDataResumePasienIGD resume=new RMDataResumePasienIGD(null,false);
            resume.isCek();
            resume.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            resume.setLocationRelativeTo(internalFrame1);
            resume.setNoRm(TNoRw.getText(),DTPCari2.getDate());
    ...
    }//GEN-LAST:event_BtnResumeIGDActionPerformed
    ...
    */
    ...
    private widget.Button BtnResumeIGD;
    ...
    public void setNoRm(String norwt,Date tgl1,Date tgl2) {
        ...
        if(KdPeg.getText().equals("d0015")){ //poli bedah onkologi dr. Muchammad Saiful Sp.B, (K)Onk
            //Hapus Tab yang tidak diperlukan
//            internalFrame3.setVisible(false);
//            internalFrame4.setVisible(false);
//            internalFrame6.setVisible(false);
//            internalFrame7.setVisible(false);
//            internalFrame8.setVisible(false);
            
            //Hapus Tab yang tidak diperlukan (old method)
            TabRawat.remove(internalFrame3);
            TabRawat.remove(internalFrame4);
            TabRawat.remove(internalFrame6);
            TabRawat.remove(internalFrame7);
            TabRawat.remove(internalFrame8);
            

            //Load Ulang Data SOAP
            tampilPemeriksaan();
        } else {
            //Hapus Tab yang tidak diperlukan
...
//            internalFrame7.setVisible(true);
//            internalFrame8.setVisible(true);
    ...
    public void isCek(){
        ...
        BtnResumeIGD.setVisible(akses.getpenilaian_awal_medis_igd()); 
...
//            String diaU = Sequel.cariIsi("SELECT penyakit.nm_penyakit FROM diagnosa_pasien inner join penyakit on diagnosa_pasien.kd_penyakit=penyakit.kd_penyakit where diagnosa_pasien.no_rawat='"+tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString()+"' AND diagnosa_pasien.prioritas=1");
//            String dia1 = Sequel.cariIsi("SELECT penyakit.nm_penyakit FROM diagnosa_pasien inner join penyakit on diagnosa_pasien.kd_penyakit=penyakit.kd_penyakit where diagnosa_pasien.no_rawat='"+tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString()+"' AND diagnosa_pasien.prioritas=2");
//            String dia2 = Sequel.cariIsi("SELECT penyakit.nm_penyakit FROM diagnosa_pasien inner join penyakit on diagnosa_pasien.kd_penyakit=penyakit.kd_penyakit where diagnosa_pasien.no_rawat='"+tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString()+"' AND diagnosa_pasien.prioritas=3");
//            String dia3 = Sequel.cariIsi("SELECT penyakit.nm_penyakit FROM diagnosa_pasien inner join penyakit on diagnosa_pasien.kd_penyakit=penyakit.kd_penyakit where diagnosa_pasien.no_rawat='"+tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString()+"' AND diagnosa_pasien.prioritas=4");
//            String dia4 = Sequel.cariIsi("SELECT penyakit.nm_penyakit FROM diagnosa_pasien inner join penyakit on diagnosa_pasien.kd_penyakit=penyakit.kd_penyakit where diagnosa_pasien.no_rawat='"+tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString()+"' AND diagnosa_pasien.prioritas=5");
//            
//            System.err.println("DU : "+diaU);
//            System.err.println("D1 : "+dia1);
//            System.err.println("D2 : "+dia2);
//            System.err.println("D3 : "+dia3);
//            System.err.println("D4 : "+dia4);
//            
//            String gabungPenilaian="";
//            
//            if (diaU.isEmpty()){
//                diaU="";
//            } else {
...
//            }
//                        
//            gabungPenilaian = diaU+dia1+dia2+dia3+dia4;
            
//            TPenilaian.setText(gabungPenilaian);
        }
    }
    ...
    private void tampilTindakanDr() { //Done MATCH() AGAINST()
        try{     
            jml=0;
            ...
            if(poli_ralan.equals("Yes")&&cara_bayar_ralan.equals("Yes")){
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   ...
                   "where jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' "
                        + "and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and jns_perawatan.kd_jenis_prw like ? or "+
                    "jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' "
                        + "and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and jns_perawatan.nm_perawatan like ? or "+
                    "jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' "
                        + "and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and kategori_perawatan.nm_kategori like ? or "
                        + " jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' "
                        + "and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and MATCH(jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan) AGAINST(?) "
                ...
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   ...
                   "where jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and jns_perawatan.kd_jenis_prw like ? or "+
                    ...
                    "jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and kategori_perawatan.nm_kategori like ? or "
                        + " jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and MATCH(jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan) AGAINST(?) "
                        + " order by jns_perawatan.nm_perawatan ");        
                ...
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   ...
                   "where jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and jns_perawatan.kd_jenis_prw like ? or "+
                    ...
                    "jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and kategori_perawatan.nm_kategori like ? or "
                        + " jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and MATCH(jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan) AGAINST(?) "
                        + " order by jns_perawatan.nm_perawatan ");     
                ...
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   ...
                   "where jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' and jns_perawatan.kd_jenis_prw like ? or "+
                    ...
                    "jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' and kategori_perawatan.nm_kategori like ? or "
                        + " jns_perawatan.total_byrdr>0 and jns_perawatan.status='1' and MATCH(jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan) AGAINST(?) "
                        + " order by jns_perawatan.nm_perawatan "); 
            }
            ...
            try {
                if(poli_ralan.equals("Yes")&&cara_bayar_ralan.equals("Yes")){
                    ...
                    pstindakan.setString(10,kd_pj.trim());
                    pstindakan.setString(11,kode_poli.trim());
                    pstindakan.setString(12,"%"+TCari.getText().trim()+"%");
                    ...
                    pstindakan.setString(5,kode_poli.trim());
                    pstindakan.setString(6,"%"+TCari.getText().trim()+"%");
                    pstindakan.setString(7,kode_poli.trim());
                    pstindakan.setString(8,"%"+TCari.getText().trim()+"%");
                    rstindakan=pstindakan.executeQuery();
                }else if(poli_ralan.equals("No")&&cara_bayar_ralan.equals("No")){
    ...
    private void tampilTindakanPr() { //Done MATCH() AGAINST()
        try{     
            jml=0;
            ...
            if(poli_ralan.equals("Yes")&&cara_bayar_ralan.equals("Yes")){
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   ...
                   "jns_perawatan.tarif_tindakandr,jns_perawatan.tarif_tindakanpr,jns_perawatan.kso,jns_perawatan.menejemen from jns_perawatan inner join kategori_perawatan "+
                   "on jns_perawatan.kd_kategori=kategori_perawatan.kd_kategori  "+
                   "where jns_perawatan.total_byrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') "
                    + "and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and jns_perawatan.kd_jenis_prw like ? or "+
                    "jns_perawatan.total_byrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') "
                    + "and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and jns_perawatan.nm_perawatan like ? or "+
                    "jns_perawatan.total_byrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') "
                    + "and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and kategori_perawatan.nm_kategori like ? or"
                    + " jns_perawatan.total_byrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') "
                    + "and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and MATCH(jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan) AGAINST(?)"
                    + " order by jns_perawatan.nm_perawatan "); 
            }else if(poli_ralan.equals("No")&&cara_bayar_ralan.equals("Yes")){
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   "jns_perawatan.total_byrdr,jns_perawatan.total_byrpr,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"+
                   ...
                   "where jns_perawatan.total_byrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and jns_perawatan.kd_jenis_prw like ? or "+
                    ...
                    "jns_perawatan.total_byrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and kategori_perawatan.nm_kategori like ? or "
                        + " jns_perawatan.total_byrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and MATCH(jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan) AGAINST(?)"
                        + " order by jns_perawatan.nm_perawatan ");        
            }else if(poli_ralan.equals("Yes")&&cara_bayar_ralan.equals("No")){
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   "jns_perawatan.total_byrdr,jns_perawatan.total_byrpr,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"+
                   ...
                   "where jns_perawatan.total_byrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and jns_perawatan.kd_jenis_prw like ? or "+
                    ...
                    "jns_perawatan.total_byrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and kategori_perawatan.nm_kategori like ? or "
                        + " jns_perawatan.total_byrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and MATCH(jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan) AGAINST(?)"
                        + " order by jns_perawatan.nm_perawatan ");     
            }else if(poli_ralan.equals("No")&&cara_bayar_ralan.equals("No")){
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   "jns_perawatan.total_byrdr,jns_perawatan.total_byrpr,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"+
                   ...
                   "where jns_perawatan.total_byrpr>0 and jns_perawatan.status='1' and jns_perawatan.kd_jenis_prw like ? or "+
                    ...
                    "jns_perawatan.total_byrpr>0 and jns_perawatan.status='1' and kategori_perawatan.nm_kategori like ? or "
                        + " jns_perawatan.total_byrpr>0 and jns_perawatan.status='1' and MATCH(jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan) AGAINST(?)"
                        + " order by jns_perawatan.nm_perawatan "); 
            }
    ...
    private void tampilTindakanDrPr() { //Done MATCH() AGAINST()
        try{     
            jml=0;
            ...
            if(poli_ralan.equals("Yes")&&cara_bayar_ralan.equals("Yes")){ 
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   ...
                   "jns_perawatan.tarif_tindakandr,jns_perawatan.tarif_tindakanpr,jns_perawatan.kso,jns_perawatan.menejemen from jns_perawatan inner join kategori_perawatan "+
                   "on jns_perawatan.kd_kategori=kategori_perawatan.kd_kategori  "+
                   "where jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') "
                        + "and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and jns_perawatan.kd_jenis_prw like ? or "+
                    "jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') "
                        + "and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and jns_perawatan.nm_perawatan like ? or "+
                    "jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') "
                        + "and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and kategori_perawatan.nm_kategori like ? or "
                        + " jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') "
                ...
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   ...
                   "where jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and jns_perawatan.kd_jenis_prw like ? or "+
                    ...
                    "jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and kategori_perawatan.nm_kategori like ? or "
                        + " jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and MATCH(jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan) AGAINST(?) "
                        + " order by jns_perawatan.nm_perawatan ");        
            }else if(poli_ralan.equals("Yes")&&cara_bayar_ralan.equals("No")){
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   "jns_perawatan.total_byrdr,jns_perawatan.total_byrpr,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"+
                   ...
                   "where jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and jns_perawatan.kd_jenis_prw like ? or "+
                    ...
                    "jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and kategori_perawatan.nm_kategori like ? or "
                        + " jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') and MATCH(jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan) AGAINST(?) "
                        + " order by jns_perawatan.nm_perawatan ");     
            }else if(poli_ralan.equals("No")&&cara_bayar_ralan.equals("No")){
                pstindakan=koneksi.prepareStatement("select jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   "jns_perawatan.total_byrdr,jns_perawatan.total_byrpr,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"+
                   ...
                   "where jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and jns_perawatan.kd_jenis_prw like ? or "+
                    ...
                    "jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and kategori_perawatan.nm_kategori like ? or "
                        + " jns_perawatan.total_byrdrpr>0 and jns_perawatan.status='1' and MATCH(jns_perawatan.kd_jenis_prw,jns_perawatan.nm_perawatan) AGAINST(?) "
                        + " order by jns_perawatan.nm_perawatan "); 
            }
