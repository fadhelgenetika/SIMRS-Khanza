...
public final class RMCariKeluhan extends javax.swing.JDialog {
    ...
    public RMCariKeluhan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Tanggal","Jam","Keluhan","Dokter"};
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,pemeriksaan_ralan.keluhan, dokter.nm_dokter "+
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat,pemeriksaan_ranap.keluhan, dokter.nm_dokter "+
